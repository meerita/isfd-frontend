...
// Purpose: Create cities via the admin form wiring auth cookies
...
type CreateCityPayload = Readonly<{
  name: string;
  countryCode: string;
  country?: string;
...
const buildPayload = (formData: FormData): CreateCityPayload => ({
...
export async function createCity(
  ...
  try {
    await api.post(API_ROUTES.CITIES, body, {
      headers,
    });
