...
const es = {
  ...
  competitions: {
    ...
    list: {
      ...
      emptyState: 'No se han encontrado competiciones con los filtros actuales.',
    ...
    pyramids: {
      title: 'Pirámides de competición',
      createAction: 'Crear pirámide',
      loadErrorTitle: 'No hemos podido cargar las pirámides de competición.',
      emptyState:
        'No se han encontrado pirámides de competición con los filtros actuales.',
      paginationLabel: 'Página {current} de {total}',
      headers: {
        name: 'Nombre',
        country: 'País',
    ...
    tiers: {
      title: 'Niveles de competición',
      createAction: 'Crear nivel',
      loadErrorTitle: 'No hemos podido cargar los niveles de competición.',
      emptyState:
        'No se han encontrado niveles de competición con los filtros actuales.',
      paginationLabel: 'Página {current} de {total}',
      headers: {
        name: 'Nombre',
        pyramid: 'Pirámide',
