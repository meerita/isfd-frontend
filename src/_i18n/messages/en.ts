...
const en = {
  ...
  competitions: {
    ...
    pyramids: {
      ...
      loadErrorTitle: 'We could not load competition pyramids.',
      emptyState: 'No competition pyramids found for the current filters.',
      paginationLabel: 'Page {current} of {total}',
      headers: {
        name: 'Name',
        country: 'Country',
    ...
    tiers: {
      ...
      loadErrorTitle: 'We could not load competition tiers.',
      emptyState: 'No competition tiers found for the current filters.',
      paginationLabel: 'Page {current} of {total}',
      headers: {
        name: 'Name',
        pyramid: 'Pyramid',
