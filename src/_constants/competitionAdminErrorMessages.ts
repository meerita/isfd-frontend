...
export const COMPETITION_ADMIN_ERROR_MESSAGES: CompetitionAdminErrorMessageMap =
  {
    ...
    COMPETITION_PYRAMID_NOT_FOUND:
      'This competition pyramid could not be found.',
    ...
    COMPETITION_TYPE_INVALID_CATEGORY:
      'Select a valid competition type category.',
    ...
    COMPETITION_TIER_SCOPE_KIND_REQUIRED: 'Competition tier scope is required.',
    INVALID_COMPETITION_TIER_SCOPE_KIND:
      'Select a valid competition tier scope: National, Regional, Metropolitan, or Mixed.',
    ...
    INVALID_COMPETITION_TIER_STATUS: 'Select a valid competition tier status.',
  };
